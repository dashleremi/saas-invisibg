  ...
  return (
    <div className='mx-4 my-3 lg:max-44 mt-14 min-h-[75vh]'>
      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex justify-center sm:justify-end items-center flex-wrap gap-8 mt-6 font-secondary text-xl'>
          ...
          <a className='px-8 py-3 text-white rounded-full bg-[#000000de] hover:bg-[#47474726] transition-all duration-300' href="">Download image</a>
        </div>
      </div>
